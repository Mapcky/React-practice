...
const LatestPosts = ({ posts, limit = 3 }: LatestPostsProps) => {
  ...
  return (
    <section className="max-w6xl mx-auto px-6 py-12">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {latest.map((post) => (
          <Link
            key={post.slug}
            to={`/blog/${post.slug}`}
            className="block p-4 border border-gray-700 rounded-lg bg-gray-800 hover:shadow-md transition cursor-pointer"
          >
